...
describe 'Games API', type: :request do
  describe 'GET /index' do
    ...
    it 'returns success status on index endpoint with all games' do
      get '/api/v1/index'
    ...
    it 'should accept pagination options parameters (page, per_page)' do
      get '/api/v1/index?page=2&per_page=1'
  ...
  describe 'POST /new' do
    it 'creates a new game successfully' do
      expect {
        post '/api/v1/new', params: { name: 'felipe', move: 'scissors' }
    ...
    it 'returns a validation error if request move input is incorrect' do
      expect {
        post '/api/v1/new', params: { name: 'felipe', move: 'asd' }
    ...
    it 'returns a validation error if request is missing a name' do
      expect {
        post '/api/v1/new', params: { name: '', move: 'rock' }
